...
// // Tip 10
// fit the shadow map to the scene tightly
...
// // Tip 12
// Currently, shadow maps get updated before each render.
// You can deactivate this auto-update and alert Three.js
// that the shadow maps needs update only when necessary:
...
// // Tip 29
// Some devices have a very high pixel ratio. The more pixels to render, the worse the frame rate.
renderer.setPixelRatio(Math.min(window.devicePixelRatio, 2))
